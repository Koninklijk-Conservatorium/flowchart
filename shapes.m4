...
dnl .
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . short circuit gdy: 1) nie ma argumentu
...
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
define(__SANITIZE, ``ifelse($1,,$2,$3)'')dnl *** args: Shape's first argument, Value to display if none, normal value
define(__SHAPE_DEF, `__SANITIZE($`1', ```$1''', __CLASS_ATTR(``$1'')$2)')dnl
define(__SHAPE_INLINE, `__SANITIZE($`1', _```$1''', {node $1($`1'); ``$1''__RANDOM})')dnl
define(__SHAPE, `define(_$1, __SHAPE_INLINE($1)) define($1, __SHAPE_DEF($1, $2))')dnl COMMENT: many quotes avoid calling itself.
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
__SHAPE(Input, `[label=$1;shape="ellipse"]')dnl
__SHAPE(Output, `[label=$1;shape="ellipse"]')dnl
__SHAPE(Action, `[label=$1;shape=box]')dnl
__SHAPE(Manual, `[label=$1;shape=invtrapezium;height=0;width=0]')dnl

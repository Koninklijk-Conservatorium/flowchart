...
define(`__FL', `$4`'ifelse($1, `$3', ,`define(`$1', incr($1))__FL(`$1', `$2', `$3', `$4')')')dnl
define(`__FORLOOP', `pushdef(`$1', `$2')__FL(`$1', `$2', `$3', `$4')popdef(`$1')')dnl
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
dnl .   Graph $1 argument format analysis
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
...
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
dnl .
dnl .   __MAKE_REGEXP: Makes regexp covering graph args.
dnl .   Graph args are in form `arg1 arg2 arg3' – strings separated by space.
dnl .   Example: `\(\w+\) \(\w+\) \(\w+\)' when $1=3
dnl .
dnl .   __GET_NTH_ARG: get nth argument from input/output argument string
dnl .   based on the dynamic regexp defined above.
dnl .
dnl .   Arguments:
dnl .   $1: args (ins or outs, e.g. {IN1 IN2 IN3} and {OUT1}).
dnl .
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
define(__MAKE_REGEXP, `substr(__FORLOOP(`x', 1, $1, ` \(\w+\)'), 1)')dnl
define(__GET_NTH_ARG, `regexp($1, __MAKE_REGEXP(__COUNT_ARGS($1)), \$2)')dnl *** args, n
dnl . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
dnl .
dnl .   Input & Output noted substitution.
